...
import com.wkhalil.eshop.databinding.FragmentUserAccountBinding
import com.wkhalil.eshop.dialog.setupBottomSheetDialog
import com.wkhalil.eshop.util.Resource
import com.wkhalil.eshop.viewmodel.UserAccountViewModel
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.user.collectLatest {
                when (it) {
                    ...
                    is Resource.Error -> {
                        Snackbar.make(requireView(), it.message.toString(), Toast.LENGTH_SHORT).show()
                    }
                    else -> Unit
                }
            }
