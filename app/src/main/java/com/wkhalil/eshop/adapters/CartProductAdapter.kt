...
import com.wkhalil.eshop.databinding.CartProductItemBinding
...
class CartProductAdapter: RecyclerView.Adapter<CartProductAdapter.CartProductsViewHolder>() {
    ...
    inner class CartProductsViewHolder( val binding: CartProductItemBinding) :
        ...
        fun bind(cartProduct: CartProduct) {
            binding.apply {
                ...
                civCartProductColor.setImageDrawable(ColorDrawable(cartProduct.selectedColor?: Color.TRANSPARENT))
                tvCartProductSize.text = cartProduct.selectedSize?:"".also { civCartProductSize.setImageDrawable(ColorDrawable(Color.TRANSPARENT)) }
            }
        }
    }
    ...
    override fun onBindViewHolder(holder: CartProductsViewHolder, position: Int) {
        ...
        holder.binding.ivCartProductPlus.setOnClickListener {
            onPlusClick?.invoke(cartProduct)
        }

        holder.binding.ivCartProductMinus.setOnClickListener {
